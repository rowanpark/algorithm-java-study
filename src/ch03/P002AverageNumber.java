...
2번째 줄에 세준이의 현재 성적이 주어진다. 해당 값은 100보다 작꺼나 같은, 음이 아닌 정수이고, 적어도 1개의 값은 0보다 크다.

출력:
1번째 줄에 새로운 평균을 출력한다. 실제 정담과 출력값의 절대 오차 또는 상대 오차가 10⁻²이하이면 정답이다.
*/
package ch03;

public class P002AverageNumber {
}
